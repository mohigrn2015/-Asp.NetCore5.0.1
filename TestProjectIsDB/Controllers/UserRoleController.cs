...
using TestProjectIsDB.ViewModels;
...
namespace TestProjectIsDB.Controllers
{
    ...
    public class UserRoleController : Controller
    {
            ...
            public UserRoleController(RoleManager<ApplicationRole> roleManager, UserManager<IdentityUser> userManager, ApplicationDbContext context)
            {
